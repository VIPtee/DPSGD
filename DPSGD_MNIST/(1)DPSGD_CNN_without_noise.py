...
def main(_):
    ...
    j=0
    workbook = xlsxwriter.Workbook('/home/yxx/PythonProjects/PrivateDeepLearning-master/big_paper/(1)mnist_without_noise_1000.xlsx')
    ...
    for i in range(1,num_steps+1):
        ...
        if(i%60==1):
            ...
            now_gw_Wf1,now_gbf1,now_gw_Wf2,now_gbf2 = sess.run([gw_Wf1,gbf1,gw_Wf2,gbf2], feed_dict={x: batch[0], y_: batch[1], keep_prob: 1.0, clip_bound:now_clip_bound, sensitivity:now_sensitivity})
            ...
            now_gw_Wf1_i, now_gbf1_i, now_gw_Wf2_i, now_gbf2_i = sess.run([gw_Wf1, gbf1, gw_Wf2, gbf2],feed_dict={x: batch[0], y_: batch[1], keep_prob: 1.0, clip_bound:now_clip_bound, sensitivity:now_sensitivity})
