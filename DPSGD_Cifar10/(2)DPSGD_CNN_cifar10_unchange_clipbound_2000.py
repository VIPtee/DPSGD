...
# labels_test=tf.one_hot(labels_train,10)
# # 加载训练数据
# for i in range(5):
...
def main(_):
    ...
    num_steps = 141*5000 #epochs*train_images_number/10
    ...
    j=0
    workbook = xlsxwriter.Workbook('/home/yxx/PythonProjects/PrivateDeepLearning-master/big_paper/test111_cifar10_unchanged_2000.xlsx')
